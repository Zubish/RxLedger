  ...
  try {
    ...
    try {
      await sendSecurityEmail(
        email,
        "Your RxLedger password was changed",
        "Your RxLedger account password was changed using a verification code. If this was not you, contact your account admin immediately.",
      );
    } catch {
